...
public class AlipayController {
    ...
    public Res tradePagePay(@PathVariable Long productId){
        ...
        return Res.ok().data("formStr", formStr);
    }
    ...
    public Res cancel(@PathVariable String orderNo){

        log.info("取消订单");
        aliPayService.cancelOrder(orderNo);
        return Res.ok().setMessage("订单已取消");
    }
    ...
    public Res refunds(@PathVariable String orderNo, @PathVariable String reason){
    ...
    public Res queryRefund(@PathVariable String orderNo) throws Exception {

        log.info("查询退款");

        String result = aliPayService.queryRefund(orderNo);
        return Res.ok().setMessage("查询成功").data("result", result);
    }
    ...
    public Res queryTradeBill(
            @PathVariable String billDate,
            @PathVariable String type)  {
        log.info("获取账单url");
        String downloadUrl = aliPayService.queryBill(billDate, type);
        return Res.ok().setMessage("获取账单url成功").data("downloadUrl", downloadUrl);
    }
